    ...
    init: function () {
      ...
      el.addEventListener('raycaster-intersection', (evt) => {
        ...
        if (this.target_el.classList.contains('first-end')) {
          ...
          quiz1.setAttribute('material', { src: '#q-shi1', normalMap: '#q-shi1-NRM' });
          ...
          quiz2.setAttribute('material', { src: '#q-shi2', normalMap: '#q-shi2-NRM' });
          ...
          quiz3.setAttribute('material', { src: '#q-shi3', normalMap: '#q-shi3-NRM' });
          ...
          quiz4.setAttribute('material', { src: '#q-zon1', normalMap: '#q-zon1-NRM' });
          ...
          quiz5.setAttribute('material', { src: '#q-zon2', normalMap: '#q-zon2-NRM' });
          ...
          quiz6.setAttribute('material', { src: '#q-zon3', normalMap: '#q-zon3-NRM' });
          ...
          quiz7.setAttribute('material', { src: '#q-sei1', normalMap: '#q-sei1-NRM' });
          ...
          quiz8.setAttribute('material', { src: '#q-sei2', normalMap: '#q-sei2-NRM' });
          ...
          quiz9.setAttribute('material', { src: '#q-sei3', normalMap: '#q-sei3-NRM' });
          ...
          quiz10.setAttribute('material', { src: '#q-roku1', normalMap: '#q-roku1-NRM' });
          ...
          quiz11.setAttribute('material', { src: '#q-roku2', normalMap: '#q-roku2-NRM' });
          ...
          quiz12.setAttribute('material', { src: '#q-roku3', normalMap: '#q-roku3-NRM' });
